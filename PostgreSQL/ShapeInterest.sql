...
We have this
 ...
 MultiSeriesId |    Date    | Unemployment | Interest | Interest
---------------+------------+--------------+-----------+----------
...
*/
DROP TABLE IF EXISTS "Econ"."Interest_S0";
CREATE TABLE "Econ"."Interest_S0" AS
SELECT
  LAG("Date", 1) OVER(ORDER BY "Date") AS "PrevDate",
  "Date",
  LAG("Interest", 1) OVER () AS "PrevInterest",
  "Interest"
FROM
  "Econ"."MultiSeries";
...
*/
DROP TABLE IF EXISTS "Econ"."Interest_S1";
CREATE TABLE "Econ"."Interest_S1" AS
SELECT
  "PrevDate",
  "Date",
  "PrevInterest",
...
*/
DROP TABLE IF EXISTS "Econ"."Interest_S2";
CREATE TABLE "Econ"."Interest_S2" AS
SELECT
  "PrevDate",
  "Date",
  "PrevInterest",
  "Interest",
  CASE
    WHEN "Interest" < "PrevInterest" THEN 'Positive'
    WHEN "Interest" > "PrevInterest" THEN 'Negative'
    WHEN "Interest" = "PrevInterest" THEN 'Unchanged'
  END AS "Trend"
FROM
  "Econ"."Interest_S1"
ORDER BY "Date";
...
value.
*/
DROP TABLE IF EXISTS "Econ"."Interest_S3";
CREATE TABLE "Econ"."Interest_S3" AS
SELECT
  "PrevDate",
  "Date",
  "PrevInterest",
...
*/
DROP TABLE IF EXISTS "Econ"."Interest_S4";
CREATE TABLE "Econ"."Interest_S4" AS
SELECT 
  "PrevDate",
  "Date",
  "PrevInterest",
...
*/
DROP TABLE IF EXISTS "Econ"."Interest_S5";
CREATE TABLE "Econ"."Interest_S5" AS
SELECT 
  "PrevDate" AS "Date",
  "PrevTrend" AS "Trend",
  CASE
