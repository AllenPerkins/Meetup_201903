...
*/
DROP TABLE IF EXISTS "Econ"."Unemployment_S0";
CREATE TABLE "Econ"."Unemployment_S0" AS
SELECT
  LAG("Date", 1) OVER(ORDER BY "Date") AS "PrevDate",
  "Date",
  LAG("Unemployment", 1) OVER () AS "PrevUnemployment",
  "Unemployment"
FROM
  "Econ"."MultiSeries";
...
*/
DROP TABLE IF EXISTS "Econ"."Unemployment_S1";
CREATE TABLE "Econ"."Unemployment_S1" AS
SELECT
  "PrevDate",
  "Date",
  "PrevUnemployment",
...
SELECT
  "Date" AS "PrevDate",
  "Date",
  "Unemployment" AS "PrevUnemployment",
  "Unemployment"
FROM
  "Econ"."Unemployment_S0"
WHERE 1=1
...
*/
DROP TABLE IF EXISTS "Econ"."Unemployment_S2";
CREATE TABLE "Econ"."Unemployment_S2" AS
SELECT
  "PrevDate",
  "Date",
  "PrevUnemployment",
  "Unemployment",
  CASE
    WHEN "Unemployment" < "PrevUnemployment" THEN 'Positive'
    WHEN "Unemployment" > "PrevUnemployment" THEN 'Negative'
    WHEN "Unemployment" = "PrevUnemployment" THEN 'Unchanged'
  END AS "Trend"
FROM
  "Econ"."Unemployment_S1"
ORDER BY "Date";
...
value.
*/
DROP TABLE IF EXISTS "Econ"."Unemployment_S3";
CREATE TABLE "Econ"."Unemployment_S3" AS
SELECT
  "PrevDate",
  "Date",
  "PrevUnemployment",
...
*/
DROP TABLE IF EXISTS "Econ"."Unemployment_S5";
CREATE TABLE "Econ"."Unemployment_S5" AS
SELECT 
  "PrevDate" AS "Date",
  "PrevTrend" AS "Trend",
  CASE
